...
function recalculateOpenOrderAmounts(
  order: any,
...
async function restockOrderItemInventory(
  tx: any,
  tenantId: string,
  orderId: string,
...
async function restockOrderItemRecipe(
  tx: any,
  tenantId: string,
  orderId: string,
  product: any,
