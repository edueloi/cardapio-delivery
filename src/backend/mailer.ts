...
// URL usada nos links dos emails — pode ser diferente do APP_URL do servidor
const APP_URL = process.env.MAIL_APP_URL ?? process.env.APP_URL ?? "https://menu.develoi.com.br";
