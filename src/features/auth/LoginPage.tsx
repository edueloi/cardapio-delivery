    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-[28px] shadow-xl p-8 md:p-10">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Acesso do Dono</h1>
            <p className="text-sm text-slate-500">Entre para gerenciar seus estabelecimentos e bots.</p>
          </div>
        </div>
        ...
        <div className="mt-6 text-sm text-slate-500">
          Ainda não tem conta?{" "}
          <Link to={`/cadastro?next=${encodeURIComponent(next)}`} className="font-bold text-[#2a74ac]">
            Criar acesso
          </Link>
        </div>
      </div>
